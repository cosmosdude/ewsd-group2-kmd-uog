...
function useContributionsByFaculties(academicYearId) {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try {
                let response = await fetch(apiConfig.path.statistics.contributionsByFaculties(academicYearId), {
...
export default useContributionsByFaculties